...
class CamShiftNode(ROS2OpenCV2):
    ...
    def __init__(self, node_name):
        ...
        self.histy = pickle.load( open('/home/dhruv/catkin_ws/save.p', "rb") )
        self.hist = None
    ...
    def process_image(self, cv_image):
        try:
            ...
            if self.selection is not None and \
                printv is not None:
        #self.selection changed to self.hist12313131
        ...
        # Compute the backprojection from the histogram
                ...
                fileobj = open('/home/dhruv/catkin_ws/save5.p', 'wb')
                pickle.dump(backproject,fileobj)
                fileobj.close()
